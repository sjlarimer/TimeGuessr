...
df_daily["Michael Geography For Avg"] = df_daily["Michael Geography Midpoint"].where(
    df_daily["Sarah Geography Midpoint"].notna()
)
df_daily["Sarah Geography For Avg"] = df_daily["Sarah Geography Midpoint"].where(
    df_daily["Michael Geography Midpoint"].notna()
)
...
df_daily_filtered = df_daily_filtered[
    df_daily_filtered["Michael Geography Midpoint"].notna() | df_daily_filtered["Sarah Geography Midpoint"].notna()
]
...
for player in ["Michael", "Sarah"]:
    col = f"{player} Geography For Avg"
    df_daily_filtered[f"{player} Geography Rolling Avg"] = df_daily_filtered[col].rolling(window=window_length, min_periods=1).mean()
    df_daily_filtered[f"{player} Geography Cumulative Avg"] = df_daily_filtered[col].expanding(min_periods=1).mean()
...
fig.add_trace(go.Scatter(
    ...
    y=df_daily_filtered["Michael Geography Midpoint"],
    mode='markers',
...
fig.add_trace(go.Scatter(
    x=df_daily_filtered["Date"],
    y=df_daily_filtered["Sarah Geography Midpoint"],
    mode='markers',
...
fig.add_trace(go.Scatter(
    x=df_daily_filtered["Date"],
    y=df_daily_filtered["Michael Geography Rolling Avg"],
    mode='lines',
...
fig.add_trace(go.Scatter(
    x=df_daily_filtered["Date"],
    y=df_daily_filtered["Sarah Geography Rolling Avg"],
    mode='lines',
...
fig.add_trace(go.Scatter(
    x=df_daily_filtered["Date"],
    y=df_daily_filtered["Michael Geography Cumulative Avg"],
    mode='lines',
...
fig.add_trace(go.Scatter(
    x=df_daily_filtered["Date"],
    y=df_daily_filtered["Sarah Geography Cumulative Avg"],
    mode='lines',
...
# --- Display plot ---
st.plotly_chart(fig, use_container_width=True, key="geography_scores_chart")